      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center mb-12 sm:mb-20">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-2xl sm:text-3xl font-bold text-[#E5E7EB]">
        ...
        >
          {highlights.map((item, index) => (
            <motion.div
              ...
              className="group p-5 sm:p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-[#6366F1]/50 transition-all duration-300 hover:shadow-lg hover:shadow-[#6366F1]/20"
            >
